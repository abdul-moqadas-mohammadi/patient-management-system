...
public class BillingServiceGrpcClient {
    ...
    public BillingServiceGrpcClient(@Value("${billing.service.address:localhost}") String serverAddress,
               ...
               log.info("Conneting to billing service GRPC at {}:{}",serverAddress,serverPort); 
    ...
    public BillingResponse createBillingAccout(String patientId,String name, String email){
